...
def remove_vegnetting_effect(veg_image, mask, add_brightness = False):
...
def main():
    ...
    if args.image:
        ...
        removed_vegnetted_effect = remove_vegnetting_effect(output_image, mask, False)
        fig, axxr = plt.subplots(1, 3)
        titles = ["original", "Vegnetting effect", "removed effect"]
        images = [orig_image, output_image, removed_vegnetted_effect]
